...
struct NotificationCenterView: View {
    ...
    // Color de fondo consistente (Deep Space)
            ...
            VStack(spacing: 0) {
                ...
                HStack {
                    ...
                    Text("Notificaciones")
                        .font(.headline)
                        .bold()
                        .foregroundColor(.white) // Color forzado a blanco
...
// Fila de Notificación (Diseño Glassmorphism)
struct NotificationRow: View {
    ...
    var body: some View {
        HStack(alignment: .top, spacing: 15) {
            ...
            Circle()
                .fill(item.read ? Color.gray.opacity(0.3) : Color(red: 0.33, green: 0.78, blue: 0.93)) // Cyan para no leídos
            ...
            VStack(alignment: .leading, spacing: 6) {
                HStack {
                    ...
                    Spacer()
                    // Formato de fecha relativo o corto
        ...
        .overlay(
            RoundedRectangle(cornerRadius: 16)
                .stroke(Color.white.opacity(item.read ? 0.05 : 0.15), lineWidth: 1)
        )
    }
}
        ...
        VStack(spacing: 20) {
            ...
            VStack(spacing: 8) {
                Text("Sin notificaciones")
                    .font(.title3.bold())
                    .foregroundColor(.white.opacity(0.8))
                Text("Te avisaremos cuando ocurra algo importante.")
                    .font(.caption)
                    .foregroundColor(.gray)
